...
import { useCreateCostCodeCategory, useUpdateCostCodeCategory } from '@/hooks/useCostManagement';
...
const CostCodeCategoryModal = ({ isOpen, onClose, mode, data }: CostCodeCategoryModalProps) => {
  ...
  useEffect(() => {
    if (mode === 'edit' && data) {
      ...
      setFormData({ name: '', slug: '', description: '', stepNumber: 1, displayOrder: 0, isActive: true });
    }
  }, [mode, data]);
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg w-full max-w-md p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">{mode === 'create' ? 'Create' : 'Edit'} Cost Code Category</h2>
