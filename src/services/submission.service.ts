...
export const submissionService = {
  ...
  getAll: async (
    ...
    return axios.get<ApiResponse<Submission[]>>(`${API_URL}/submissions`, {
      params,
    });
  },
  ...
  getBySubmissionNumber: async (submissionNumber: string) => {
    return axios.get<ApiResponse<Submission>>(
      `${API_URL}/submissions/by-number/${submissionNumber}`,
    );
  },

  getDashboardStats: async () => {
    return axios.get<ApiResponse<DashboardStats>>(
      `${API_URL}/submissions/dashboard-stats`,
    );
  },

  updateStatus: async (id: string, status: SubmissionStatus) => {
    return axios.patch<ApiResponse<Submission>>(
  ...
  regeneratePdf: async (id: string) => {
    return axios.post<ApiResponse<Submission>>(
      `${API_URL}/submissions/${id}/regenerate-pdf`,
    );
  },
  ...
  archiveMany: async (ids: string[]) => {
    return axios.post<ApiResponse<{ count: number }>>(
      `${API_URL}/submissions/bulk-archive`,
      { ids },
    );
  },
  ...
  deleteMany: async (ids: string[]) => {
    return axios.post<ApiResponse<{ count: number }>>(
      `${API_URL}/submissions/bulk-delete`,
      { ids },
    );
  },
  ...
  updateNextStep: async (
    ...
    return axios.patch<ApiResponse<any>>(
      `${API_URL}/submissions/next-steps/${id}`,
      data,
    );
  },
  ...
  addMedia: async (
    ...
    return axios.post<ApiResponse<any>>(
      `${API_URL}/submissions/${submissionId}/media`,
      data,
    );
  },
};
